...
IFACE = "wlan0"#python obj for listening over a WIFI Network

SIOCGIFFLAGS = 0x8913	#sets the interface flags 
SOICSIFFLAGS = 0x8914	#gets the intergace flags 
...
def set_promiscous_mode(sock : socket:socket, iface : str) -> None:
